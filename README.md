...
Меня зовут Владимир, и я Fullstack разработчик на Python и DevOps инженер с более чем тремя годами практики в области веб-разработки. В данный момент ищу возможность присоединиться к команде, где смогу дальше развиваться и внести вклад в создание хорошего кода.
***
📫 Контакты:
